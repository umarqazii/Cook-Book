        ...
        <Drawer
          ...
          <div className="flex flex-col ">
            <div className="flex justify-center flex-col items-center">
              <div className="bg-slate-400 mt-2 mb-2 sm:w-1/3 w-2/3 h-1 border rounded-lg cursor-pointer" onClick={toggleDrawer}></div>
              <h2 className="text-xl mb-10 cursor-pointer" onClick={toggleDrawer}>
